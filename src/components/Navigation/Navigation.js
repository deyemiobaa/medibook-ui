...
export default function Navigation() {
  ...
  return (
    <div className="navigation w-[100%] sm:static sm:w-[25%]  bg-gray-300 flex flex-col sm:max-h-full ">
      ...
      <div className={` navLinks flex flex-col  mt-44 items-center sm:items-start h-[10%]  w-[100%] sm:pl-[15px] pb-12 pt-0 ${open ? 'bg-gray-300 ' : 'hidden sm:flex-col'}`}>
