  ...
  return (
    <div className="navigation sm:w-[15%] bg-white flex justify-between items-center sm:flex-col sm:border-r sm:border-r-gray-400 border-b border-b-gray-400 fixed top-0 left-0 sm:bottom-0 px-3 sm:pb-10 sm:px-0">
      ...
      <div className="hidden w-full navLinks sm:flex sm:flex-col">
        {/* {role === 'admin' && (
        <>
          <NavLink to="/add-item" className="link-el hover:bg-lime-400 text-base hover:text-[#fff]
           ease-in duration-300 font-medium mb-2 p-3 pl-10">Add Item</NavLink>
          <NavLink to="delete-item" className="link-el hover:bg-lime-400 text-base hover:text-[#fff]
           ease-in duration-300 font-medium mb-2 p-3 pl-10">Delete Item</NavLink>
        </>
        )} */}
        <NavLink to="/add-item" className="link-el hover:bg-lime-400 text-base hover:text-[#fff] ease-in duration-300 font-medium mb-2 p-3 pl-10">Add Item</NavLink>
        <NavLink to="delete-item" className="link-el hover:bg-lime-400 text-base hover:text-[#fff] ease-in duration-300 font-medium mb-2 p-3 pl-10">Delete Item</NavLink>
        {urls.map(({ path, name }) => (
